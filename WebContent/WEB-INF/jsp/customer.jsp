...
<%@ taglib prefix="news" uri="http://com.news/"%>
<%
...
<!-- MetisMenu CSS -->
<link href="<%=basePath%>css0/metisMenu.min.css" rel="stylesheet">
...
<body>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<news:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post(
					"<%=basePath%>customer/update1.action",
